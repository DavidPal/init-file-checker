...
class TestInitFileChecker(unittest.TestCase):
    ...
    def test_find_parent_directories(self):
    ...
    def test_find_all_python_files_recursively(self):
    ...
    def test_find_all_parent_directories(self):
        ...
        self.assertSetEqual(
            ...
            init_file_checker.find_all_parent_directories(
                ["/path/to/some/file.txt", "/path/to/another/file.txt"], "/path/to"
            ),
        )

    def test_find_missing_init_files(self):
